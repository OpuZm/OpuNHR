...
namespace OPUPMS.Infrastructure.Common.Net
{
    /// <summary>
    /// 网络操作
    /// </summary>
    public class Net
    {
        ...
        public static string GetLocation(string ip)
        {
            ...
            try
            {
                string key = "b39857e36bee7a305d55cdb113a9d725";//此key 做测试用
                string url = "http://apis.juhe.cn/ip/ip2addr?ip=" + ip + "&dtype=json&key=" + key;
