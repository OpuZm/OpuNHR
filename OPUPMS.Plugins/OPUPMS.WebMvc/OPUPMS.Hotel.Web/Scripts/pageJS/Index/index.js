...
//初始化layui
layui.config({
    base: '/Plugins/Web/OPUPMS.Hotel.Web/Scripts/pageJS/'
    ...
    $.ajax({
        url: "/CloudPMS/GetClientMenuJson",
        data: {},
        type: "get",
        dataType: "json",
    ...
    element.on('tab(admin-tab)', function () {
        ...
        if (title != '首页') {
            ...
            if ($('#page_home #main').length < 1) {
                $('#page_home').html('<iframe id="main" style="height:800px;" src="/CloudPMS/Home"></iframe>');
            }
