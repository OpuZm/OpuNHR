			...
			if(data[i].children !== undefined && data[i].children.length > 0) {
				...
				if(data[i].icon !== undefined && data[i].icon !== '') {
					if(data[i].icon.indexOf('icon-') !== -1) {
						ulHtml += '<i class=" ' + data[i].icon + '" aria-hidden="true" data-icon="' + data[i].icon + '"></i>';
					} else {
				...
				for(var j = 0; j < data[i].children.length; j++) {
					ulHtml += '<dd>';
					ulHtml += '<a href="javascript:;" id="main_nav_'+ data[i].children[j].id +'" data-url="' + data[i].children[j].href + '" data-id="'+ data[i].children[j].id +'">';
					if(data[i].children[j].icon !== undefined && data[i].children[j].icon !== '') {
						if(data[i].children[j].icon.indexOf('icon-') !== -1) {
							ulHtml += '<i class="' + data[i].children[j].icon + '" data-icon="' + data[i].children[j].icon + '" aria-hidden="true"></i>';
						} else {
