...
namespace OPUPMS.Domain.Hotel.Model
{
    ...
    /// </summary>
    [Table("Dfzldd")]
    public class DfzlddModel : Entity<int>
    {
        static DfzlddModel()
        {
            OrmConfiguration.GetDefaultEntityMapping<DfzlddModel>()
                .SetProperty(entity => entity.Id,
                    prop =>
                    {
                        prop.SetDatabaseColumnName("Dfzlddxh00");
                        prop.SetDatabaseGenerated(DatabaseGeneratedOption.Identity);
                    });
        }

        ///// <summary>
        ///// Dfzlddxh00 序号 主键 标识列
        ///// </summary>
        //public virtual int Dfzlddxh00
        //{
        //    get;
        //    set;
        //}
        ...
        /// 操作员 关联Czdm.Czdmdm00
        /// </summary>
        public virtual string Dfzlddczdm
        {
            get;
            set;
        }
        ...
        /// Dfzlddczsj 操作时间
        /// </summary>
        public virtual DateTime Dfzlddczsj
        {
            get;
            set;
        }
        ...
        /// Dfzlddzwrq 账务日期
        /// </summary>
        public virtual DateTime Dfzlddzwrq
        {
            get;
            set;
        }
        ...
        /// 关联系统代码 ZT
        /// </summary>
        public virtual string Dfzlddzt00
        {
            get;
            set;
        }
