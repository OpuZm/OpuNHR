...
{
    public abstract class PluginVirtualPathProviderViewEngine : IViewEngine
    {
        ...
        protected PluginVirtualPathProviderViewEngine()
        {
        ...
        public string[] PluginNameSpaceMasterLocationFormats { get; set; }

        [SuppressMessage("Microsoft.Performance", "CA1819:PropertiesShouldNotReturnArrays", Justification = "This is a shipped API")]
        public string[] PluginNameSpacePartialViewLocationFormats { get; set; }

        [SuppressMessage("Microsoft.Performance", "CA1819:PropertiesShouldNotReturnArrays", Justification = "This is a shipped API")]
        public string[] PluginNameSpaceViewLocationFormats { get; set; }
        ...
        public virtual ViewEngineResult FindPartialView(ControllerContext controllerContext, string partialViewName, bool useCache)
        {
            ...
            string partialPath = GetPath(controllerContext, PartialViewLocationFormats, PluginNameSpacePartialViewLocationFormats, "PartialViewLocationFormats", partialViewName, controllerName, CacheKeyPrefixPartial, useCache, out searched);
        ...
        public virtual ViewEngineResult FindView(ControllerContext controllerContext, string viewName, string masterName, bool useCache)
        {
            ...
            string controllerName = controllerContext.RouteData.GetRequiredString("controller");
            string viewPath = GetPath(controllerContext, ViewLocationFormats, PluginNameSpaceViewLocationFormats, "ViewLocationFormats", viewName, controllerName, CacheKeyPrefixView, useCache, out viewLocationsSearched);
            string masterPath = GetPath(controllerContext, MasterLocationFormats, PluginNameSpaceMasterLocationFormats, "MasterLocationFormats", masterName, controllerName, CacheKeyPrefixMaster, useCache, out masterLocationsSearched);
        ...
        private string GetPathFromGeneralName(ControllerContext controllerContext, List<ViewLocation> locations, string name, string controllerName, string nameSpace, string cacheKey, ref string[] searchedLocations)
        {
            ...
            for (int i = 0; i < locations.Count; i++)
            {
                ...
                string virtualPath = location.Format(name, controllerName, nameSpace);
        ...
        private static List<ViewLocation> GetViewLocations(string[] viewLocationFormats, string[] namespaceViewLocationFormats)
        {
            List<ViewLocation> allLocations = new List<ViewLocation>();

            if (namespaceViewLocationFormats != null)
            {
                foreach (string namespaceViewLocationFormat in namespaceViewLocationFormats)
                {
                    allLocations.Add(new NameSpaceViewLocation(namespaceViewLocationFormat));
                }
            }
        ...
        private class NameSpaceViewLocation : ViewLocation
        {
            public NameSpaceViewLocation(string virtualPathFormatString)
                : base(virtualPathFormatString)
            {
            }

            public override string Format(string viewName, string controllerName, string nameSpace)
            {
                return String.Format(CultureInfo.InvariantCulture, _virtualPathFormatString, viewName, controllerName, nameSpace);
            }
        }
        ...
        private class ViewLocation
        {
            ...
            public virtual string Format(string viewName, string controllerName, string nameSpace)
            {
